...
async def get_creative(
    ...
    return CreativeListResponse(
        ...
        psychotype=creative.psychotype,
        predicted_cvr=(creative.predicted_cvr or 0) / 10000,
