...
def upgrade() -> None:
    ...
    if not column_exists('pattern_performance', 'pattern_hash'):
        op.add_column('pattern_performance', sa.Column('pattern_hash', sa.String(255), nullable=True))
    if not column_exists('pattern_performance', 'target_audience_pain'):
    ...
    if not index_exists('ix_pattern_performance_pattern_hash'):
        op.create_index('ix_pattern_performance_pattern_hash', 'pattern_performance', ['pattern_hash'])
    if not index_exists('ix_pattern_performance_target_audience_pain'):
